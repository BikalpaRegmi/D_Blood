            ...
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-6 flex flex-wrap gap-4 justify-center">
                    ...
                    <b
                      ...
                      className="bg-gray-300 cursor-pointer hover:bg-gray-400 text-gray-700 py-2 px-4 rounded"
                      >
                      Edit Profile
                    </b>
                ...
                <div className="flex flex-col">
                  ...
                  <ul>
                    <li className="mb-2">
                      BloodType : {myDetail.bloodType} 
                    </li>
                    <li className="mb-2">
                      Date Of Birth : {myDetail.dateOfBirth}
                    </li>
                    <li className="mb-2">Gender : {myDetail.gender}</li>
                    <li className="mb-2">Address : {myDetail.myAddress}</li>
                    <li className="mb-2">
                      Emergency Contact : {Number(myDetail.emergencyContact)}{" "}
                    </li>
                    <li className="mb-2 bg-slate-100">
                      Medical Report :{" "}
                      <a href={myDetail.medicalReport} target="_blank">
                        <img
